    ...
    >
      ...
      <div v-if="!collapsed" class="sider-user-pro">
        ...
        <a-avatar src="https://i.pravatar.cc/100" :size="80" />
            <div class="username">Ariel - Administrador</div>
        </div>
...
const procesos = ref([
  { value: 1, label: "Proceso 2025" },
  { value: 2, label: "Proceso 2024" },
]);

const menuItems = [
  { key: "dashboard", icon: AppstoreFilled, label: "Dashboard", route: "/admin" },
  {
    key: "configuracion",
    icon: SettingFilled,
    label: "Configuración",
  ...
  },
  {
    ...
    label: "Reportes",
    children: [
      { key: "resumen", icon: FileTextOutlined, label: "Resumen", route: "/admin/tarifas" },
    ],
  },
];
